...
public class Bus {
	...
	public Bus(int busno, String date, String bname, String routefrom, String routeto, String boardingpoint,
			String arrivingpoint, String btype, String arrival, String departure, int totalseats, int avaliableseats,
			int amount) {
		super();
		this.busno = busno;
		this.date = date;
